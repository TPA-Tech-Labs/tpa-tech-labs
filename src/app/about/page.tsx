...
import HexVisual from "@/components/sections/HexVisual";
  ...
  return (
    <>
      ...
      <section style={{ padding:"80px 32px", background:"linear-gradient(135deg,#0A0E1A 0%,#0A2E6B 60%,#0A0E1A 100%)", color:"white", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ maxWidth:1280, margin:"0 auto", position:"relative", display:"grid", gridTemplateColumns:"1.3fr 1fr", gap:48, alignItems:"center" }}>
          <div>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:24 }}>
            {TEAM_VALUES.map((v, i) => (
              <div key={v.title} style={{ padding:32, border:"1px solid #E2E8F0", borderRadius:16, background:"#F8FAFC" }}>
                <div className="tpa-icon-tile" style={{ width:48, height:48, borderRadius:12, background:"linear-gradient(135deg,#00C6FF,#0072FF)", display:"flex", alignItems:"center", justifyContent:"center", color:"white", marginBottom:20, animationDelay:`${i * 0.45}s` }}>
